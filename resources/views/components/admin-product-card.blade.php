...
>
    ...
    >
        <div class="flex items-center gap-2">
            <a
                href="{{ route('admin.nextspaces.edit', $nextspaceId) }}"
            ...
            <form
                action="{{ route('admin.nextspaces.destroy', $nextspaceId) }}"
                method="POST"
                class="inline-block"
            >
                @csrf
    ...
    <div class="relative overflow-hidden">
        ...
        <div
            class="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0"
        >
