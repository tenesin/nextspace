        ...
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
            ...
            @if ($penalty)
                <p class="mb-4 text-gray-700">
                    You canceled less than 1 hour before your booking time.
                    <br />
                    <span class="font-semibold text-red-600">
                        A penalty of 25% ( ${{ number_format($penaltyAmount, 2) }} ) of your
                        reservation cost applies.
                    </span>
                </p>
                <p class="mb-6 text-gray-600">Please proceed to payment to settle your penalty.</p>
                <a
                    href="{{ route('payment.penalty', ['booking' => $booking->id]) }}"
