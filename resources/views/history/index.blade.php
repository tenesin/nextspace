        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg">
                @if ($bookings->isEmpty())
                    ...
                    <div class="text-center py-16">
                        ...
                        <p class="text-gray-600 mb-6 text-sm">
                            Mulai jelajahi ruang kerja amazing kami!
                        </p>
                        <a
                ...
                @else
                    {{-- Filter Section --}}
                    <div
                        class="p-4 border-b border-gray-200 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between"
                    >
                        <form
                            method="GET"
                            ...
                            <div class="p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex gap-4">
                                    ...
                                    <div class="relative flex-shrink-0">
                                        <img
                                            src="{{ $booking->nextspace_image_url ?? 'https://placehold.co/80x80/E3F2FD/1976D2?text=Space' }}"
                                        ...
                                        <span
                                            class="{{ $statusColor }} absolute -top-1 -right-1 w-3 h-3 rounded-full border-2 border-white"
                                        ></span>
                                    </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        >
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <div
                                                    class="flex items-center text-xs text-gray-600 mt-1"
                                                >
                                                    <svg
                                                        class="h-3 w-3 mr-1"
                                                        fill="none"
                                                    ...
                                                    <span class="truncate">
                                                        {{ $booking->nextspace_address }}
                                                    </span>
                                                </div>

                                                {{-- Compact Details --}}
                                                <div
                                                    class="flex flex-wrap gap-3 mt-2 text-xs text-gray-600"
                                                >
                                                    <div class="flex items-center">
                                                        <svg
                                                            class="h-3 w-3 mr-1"
                                            ...
                                            <div class="flex flex-col sm:items-end gap-2">
                                                ...
                                                <div class="flex flex-wrap gap-1">
                                                    <a
                                                        href="{{ route('history.show', ['booking_id' => $booking->booking_id]) }}"
                                                    ...
                                                    @if (strtolower($booking->status) === 'confirmed')
                                                        <a
                                                            href="{{ route('history.invoice', ['booking_id' => $booking->booking_id]) }}"
                                                    ...
                                                    @if (in_array(strtolower($booking->status), ['cancelled', 'canceled', 'checked in']))
                                                        <form
                                                            method="POST"
                                                            action="{{ route('history.remove', $booking->id) }}"
                                                            class="inline"
                                                        >
                                                            @csrf
                                                            @method('DELETE')
