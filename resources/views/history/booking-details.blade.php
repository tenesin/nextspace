                ...
                <div class="bg-gray-900 px-6 py-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <div
                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium @if (strtolower($booking->status) === "confirmed")
                                    bg-green-100
                            ...
                            >
                                <div
                                    class="w-2 h-2 rounded-full mr-2 @if (strtolower($booking->status) === "confirmed")
                                        bg-green-500
                                    @elseif (strtolower($booking->status) === "pending")
                                    @elseif (strtolower($booking->status) === "paid")
                                    @else
                ...
                <div class="p-6">
                        ...
                        <div class="mb-6 bg-blue-50 border border-blue-200 p-4 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <p class="text-blue-800 font-medium">
                                    Pemesanan Anda telah dikonfirmasi dan siap!
                                </p>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
                        ...
                        <div class="lg:col-span-3 space-y-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                <div class="flex flex-col md:flex-row gap-4">
                                    <div class="md:w-1/3">
                                        <img
                                            src="{{ $booking->nextspace_image_url }}"
                                    ...
                                    <div class="md:w-2/3">
                                        ...
                                        <div class="flex items-start text-gray-600">
                                            <svg
                                                class="w-5 h-5 mt-0.5 mr-2 text-red-500"
                                                fill="none"
                                                stroke="currentColor"
                                                viewBox="0 0 24 24"
                                            >
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg p-4">
                                    ...
                                    <p class="text-lg font-bold text-gray-900">
                                        {{ $booking->booked_for?->format("M d, Y") ?? "N/A" }}
                                    </p>
                                    <p class="text-gray-500 text-sm">
                                        {{ $booking->booked_for?->format("l") ?? "" }}
                                    </p>
                                </div>
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-gray-50 rounded-lg p-6 text-center">
                                <h3
                                    class="font-medium text-gray-900 mb-4 flex items-center justify-center"
                                >
                                    <svg
                                        class="w-5 h-5 text-gray-600 mr-2"
                                        fill="none"
                                ...
                                <div
                                    class="bg-white p-4 rounded-lg border-2 border-dashed border-gray-300 mb-4"
                                >
                                    <img
                                        src="{{ $qrCodeUrl }}"
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="bg-yellow-50 border border-yellow-200 rounded p-3">
                                        <p class="text-xs text-yellow-800">
                                            ...
                                            Tunjukkan QR Code ini kepada petugas untuk masuk ke
                                            ruang yang telah dipesan.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    @if (strtolower($booking->status) === "checked in" && ! $booking->review)
                        <div class="bg-gray-50 rounded-lg p-4 mb-6">
                            ...
                            <form
                                method="POST"
                                action="{{ route("reviews.store", $booking->id) }}"
                            >
                                @csrf
                                ...
                                <button
                                    type="submit"
                                    class="mt-3 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors"
                                >
                                    Submit Review
                                </button>
                            </form>
                    ...
                    @if ($penalty)
                        <div class="mb-6 bg-amber-50 border border-amber-200 rounded-lg p-4">
                            <div class="flex items-start">
                                <svg
                                    class="w-5 h-5 text-amber-600 mt-0.5 mr-2"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-amber-700">
                                        Canceling less than 1 hour before your booked time may incur
                                        a 25% penalty fee.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        <div class="flex flex-wrap gap-3 justify-center">
                            ...
                            @if (in_array(strtolower($booking->status), ["confirmed", "paid"]))
                                <form
                                    method="POST"
                                    action="{{ route("booking.checkin", $booking->id) }}"
                                >
                                    @csrf
                                    <button
                                        type="submit"
