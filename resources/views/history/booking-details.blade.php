                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-text-secondary">{{ $booking->booked_for?->format('F d, Y') ?? 'N/A' }}</p>
                        </div>
                        ...
                        @php
                            // Safely ensure selected_services_details is an array
                        ...
                        @if(!empty($safeSelectedServices))
                            <div class="mb-4">
                                <h3 class="text-text-primary font-semibold mb-2">Selected Services:</h3>
                                <ul class="list-disc list-inside text-text-secondary text-sm">
