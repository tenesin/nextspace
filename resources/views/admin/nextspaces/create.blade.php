...
<x-app-layout>
    <div class="py-6 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        >
                            <path
                                ...
                                stroke-width="2"
                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H9m0 0H5m5 0v-4a1 1 0 011-1h2a1 1 0 011 1v4m-5 0v-6a1 1 0 011-1h2a1 1 0 011 1v6"
                            ></path>
                        </svg>
                    </div>
                    <div>
            ...
            <form
                method="POST"
                action="{{ route('admin.nextspaces.store') }}"
...
{{ old('description') }}</textarea
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="5.0" {{ old('rating') == '5.0' ? 'selected' : '' }}>
                                    5.0 ⭐⭐⭐⭐⭐
                                </option>
                                <option value="4.5" {{ old('rating') == '4.5' ? 'selected' : '' }}>
                                    4.5 ⭐⭐⭐⭐⭐
                                </option>
                                <option value="4.0" {{ old('rating') == '4.0' ? 'selected' : '' }}>
                                    4.0 ⭐⭐⭐⭐
                                </option>
                                <option value="3.5" {{ old('rating') == '3.5' ? 'selected' : '' }}>
                                    3.5 ⭐⭐⭐⭐
                                </option>
                                <option value="3.0" {{ old('rating') == '3.0' ? 'selected' : '' }}>
                                    3.0 ⭐⭐⭐
                                </option>
                            </select>
                        </div>
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Hours
                        <span class="text-gray-400">(choose one or both)</span>
                    </label>
                    <div class="flex items-center gap-6 mb-2">
                        ...
                        <label class="flex items-center">
                            <input
                                type="checkbox"
                                name="hours[]"
                                value="Saturday - Sunday 08:00 - 17:00"
                        ...
                        <div>
                            ...
                            >
                                @foreach ($amenities as $amenity)
                                    <label
                                        class="flex items-center py-1 hover:bg-gray-50 px-2 rounded cursor-pointer"
                                    >
                                        <input
                                            type="checkbox"
                                            name="amenity_ids[]"
                ...
                <div class="mb-6 border-t pt-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                        @foreach ($timeSlots as $slot)
                            <label
                                class="flex items-center justify-between p-2 border border-gray-200 rounded-md hover:bg-blue-50 hover:border-blue-300 cursor-pointer text-sm"
                            >
                                <div class="flex items-center">
                                    <input
                                        type="checkbox"
                                ...
                                <select
                                    ...
                                    class="border border-gray-300 rounded px-1 py-0.5 w-12 text-xs"
                                >
                                    @for ($i = 1; $i <= 20; $i++)
                                        <option
                                            value="{{ $i }}"
                                            {{ old('capacities.' . $slot->id, 1) == $i ? 'selected' : '' }}
                                        >
                                            {{ $i }}
                                        </option>
                                    @endfor
