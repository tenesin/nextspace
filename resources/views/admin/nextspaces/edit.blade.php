...
<x-app-layout>
    <div class="py-6 bg-gray-50 min-h-screen">
        <div class="max-w-3xl mx-auto px-4">
            ...
            <form
                method="POST"
                action="{{ route('admin.nextspaces.update', $nextspace->id) }}"
                class="space-y-4"
            >
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <label class="flex items-center">
                                    <input
                                        ...
                                        {{
                                            ...
                                            (! old('hours') && in_array('mon-fri', $existingHours))
                                                ? 'checked'
                                                : ''
                                        }}
                                ...
                                <label class="flex items-center">
                                    <input
                                        ...
                                        {{
                                            ...
                                            (! old('hours') && in_array('sat-sun', $existingHours))
                                                ? 'checked'
                                                : ''
                                        }}
                                        class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea
                                ...
                                required
                            >
{{ old('description', $nextspace->description) }}</textarea
                            >
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div class="bg-white rounded-lg shadow-sm p-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                        @foreach ($allAmenities as $amenity)
                            <label
                                class="flex items-center p-2 border border-gray-200 rounded hover:border-blue-300 cursor-pointer"
                            >
                                <input
                                    type="checkbox"
                                    name="amenity_ids[]"
                ...
                <div class="bg-white rounded-lg shadow-sm p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                        @foreach ($allServices as $service)
                            <label
                                class="flex items-center justify-between p-2 border border-gray-200 rounded hover:border-blue-300 cursor-pointer"
                            >
