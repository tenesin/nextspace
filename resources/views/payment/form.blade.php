                            ...
                            <div class="mb-4">
                                ...
                                >
                                    ...
                                    @foreach ($nextspace->timeSlots as $slot)
                                        <option
                                            value="{{ $slot->id }}"
                                            {{ old('selected_time_slot_id') == $slot->id ? 'selected' : '' }}
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 max-h-32 overflow-y-auto">
                                        @foreach ($nextspace->services as $service)
                                            <label
                                                class="flex items-center p-2 bg-gray-50 rounded border hover:bg-gray-100 cursor-pointer"
                                            >
                                                <input
                                                    type="checkbox"
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-blue-700">
                                    ...
                                    <p>
                                        Anda akan menerima instruksi pembayaran setelah konfirmasi
                                        booking.
                                    </p>
                                </div>
                            </div>
