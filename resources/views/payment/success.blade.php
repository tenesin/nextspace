<x-guest-layout>
    <div class="p-8 text-center">
        ...
        <p class="text-text-secondary mb-6">Your booking for **{{ $nextspace['title'] }}** at **{{ $selected_time_slot }}** has been successfully processed.</p>
        <p class="text-text-primary mb-8">Thank you for using NextSpace!</p>

        <a href="{{ route('history.index') }}" id="viewHistoryBtn" class="inline-block bg-primary text-text-light font-semibold py-3 px-6 rounded-lg hover:bg-primary-dark transition duration-300">
            View My Bookings
        </a>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const order = {
                    ...
                    booking_date: new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' }), // Formatted date
